...
public class Rectangle {
   ...
   public Rectangle (int left,int top,int width,int height) {
    ...
    public Rectangle (int left,int top, int width) {
        ...
        this.width = width;
        this.height = width;}
    public Rectangle (Rectangle anatherRectangle) {
        this.left = anatherRectangle.left;
        this.top = anatherRectangle.top;
        this.width = anatherRectangle.width;
        this.height = anatherRectangle.height;}
